...
public class CommonAspect {
    ...
    @Pointcut("execution(* org.lili.forfun.spring.training.service.HelloService.*(..))")
    ...
    public void doBefore(JoinPoint joinPoint) throws Throwable {
        ...
        for (StackTraceElement stackTraceElement : stackTrace) {
            if (stackTraceElement.getClassName().contains("training")) {
    ...
    @Pointcut("execution(* org.lili.forfun.spring.training.service.PersonService.*(..))")
